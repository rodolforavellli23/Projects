...
# 'map()' is a higher order function that returns the output of another 
#  function that is passed as a parameter within itself over a second 
#  parameter that can be iterated over (ex: lists[], tuples() and dictionaries{}).

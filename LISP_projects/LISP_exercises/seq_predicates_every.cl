...
(defun display-every (pad n-1 e c-exp s-n-1 s-c-exp &optional (n-2 NIL) (s-n-2 NIL)) 
  (if (and (not (eq n-2 NIL)) (not (eq s-n-2 NIL)))
    (format t 
	   "~%~aAre all items in ~C\[1;38;5;208m~a~C\[0m ~
...
(my-spacer *my-pad* *my-str* *my-num*)
(display-every *my-pad* *my-sequence-1* +escape+ #'evenp "*my-sequence-1*" "even")
(my-spacer *my-pad* *my-str* *my-num*)
(display-every *my-pad* *my-sequence-1* +escape+ #'oddp "*my-sequence-1*" "odd")
(my-spacer *my-pad* *my-str* *my-num*)
(display-every *my-pad* *my-sequence-1* +escape+ #'numberp "*my-sequence-1*" "numbers")
(my-spacer *my-pad* *my-str* *my-num*)
(display-every *my-pad* *my-sequence-2* +escape+ #'> "*my-sequence-2*"
